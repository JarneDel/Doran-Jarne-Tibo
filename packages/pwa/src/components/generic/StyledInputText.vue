  ...
  <label class="block">
    ...
    <span class="flex items-center justify-center">
      <input
        ...
        :type="type"
        :value="modelValue"
        class="b-2 b-primary-light hover:border-primary focus:border-primary-dark focus-visible:border-primary-dark w-full rounded bg-white px-4 py-1.5 outline-none motion-safe:transition-colors"
        @input="
