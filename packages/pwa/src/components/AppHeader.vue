...
<template>
  <div
    class="flex items-center justify-between bg-slate-400 fill-slate-700 p-2"
  >
    <div class="flex items-center justify-center gap-2">
      ...
      >
        <g>
          <g>
            <path
              d="M27.851,21.77c-0.327,0.375-0.803,0.591-1.304,0.591c-0.498,0-0.975-0.215-1.301-0.591
            ...
            <path
              d="M15.018,21.01c0.24,0.268,0.708,0.27,0.949-0.001c1.035-1.165,2.436-1.919,3.949-2.168
      ...
      <h1 class="text-xl font-bold">{{ $t('navigation.title') }}</h1>
    </div>
